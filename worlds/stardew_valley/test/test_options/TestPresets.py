...
from ...options.options import HardModCombatExclusions
...
class TestPresets(SVTestCase):
    def test_all_presets_explicitly_set_all_options(self):
        ...
        omitted_option_names = {option_key for option_key in PerGameCommonOptions.type_hints} | {TrapItems.internal_name} | {HardModCombatExclusions.internal_name}
