...
class SVEEntrance:
    ...
    grove_to_outpost = "Enchanted Grove to Galmoran Outpost"
    grove_to_wizard = "Enchanted Grove to Wizard's Tower"
    grove_to_aurora = "Enchanted Grove to Aurora Vineyard Basement"
    grove_to_farm = "Enchanted Grove to Farm"
    grove_to_guild = "Enchanted Grove to Adventurer's Guild Summit"
    grove_to_junimo = "Enchanted Grove to Junimo Woods"
    grove_to_spring = "Enchanted Grove to Sprite Springs"
    wizard_to_fable_reef = "Wizard's Basement to Fable Reef"
    ...
    to_grandpa_upstairs = "Grandpa's Shed to Grandpa's Shed Upstairs"
    forest_to_fairhaven = "Forest to Fairhaven Farm"
    forest_to_west = "Forest to Forest West"
    forest_to_junimo = "Forest to Junimo Woods"
    ...
    jenkins_to_cellar = "Jenkins' House to Jenkins' Cellar"
    plot_to_bridge = "Unclaimed Plot to Shearwater Bridge"
    mountain_to_guild_summit = "Mountain to Adventurer's Guild Summit"
    guild_to_interior = "Adventurer's Guild Summit to Adventurer's Guild"
    guild_to_mines = "Adventurer's Guild Summit to The Mines"
    summit_to_boat = "Adventurer's Guild Summit to Marlon's Boat"
    boat_to_highlands = "Marlon's Boat to Highlands"
    ...
    highlands_to_lance = "Highlands to Lance's House Main"
    highlands_to_cave = "Highlands to Highlands Cave"
    to_dwarf_prison = "Highlands Cave to Dwarf Prison"
    lance_ladder_to_highlands = "Lance's House Ladder to Highlands"
    forest_west_to_spring = "Forest West to Sprite Springs"
