...
CookingLogicMixin, MoneyLogicMixin, CombatLogicMixin, SeasonLogicMixin, QuestLogicMixin, OptionLogicMixin]]):
    ...
    def has_iridium_bomb(self):
        return self.logic.option.choice(options.QuestLocations,
                                        ...
                                        match=self.logic.quest.can_complete_quest(ModQuest.RailroadBoulder),
                                        no_match=self.logic.received(SVEQuestItem.iridium_bomb))
