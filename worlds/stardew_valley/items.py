...
def fill_with_resource_packs_and_traps(item_factory: StardewItemFactory, options: StardewValleyOptions, random: Random,
    ...
    all_filler_packs = remove_excluded_items(all_filler_packs, world_options)
    priority_filler_items = remove_excluded_items(priority_filler_items, world_options)
...
def remove_excluded_items(packs, world_options):
