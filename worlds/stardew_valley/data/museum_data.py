...
class MuseumItem:
    ...
    def of(item_name: str,
        ...
        return MuseumItem(item_name, locations, geodes, monsters, difficulty, content_pack)
...
def create_artifact(name: str,
    ...
    artifact_item = MuseumItem.of(name, difficulty, locations, geodes, monsters, content_pack)
...
def create_mineral(name: str,
    ...
    mineral_item = MuseumItem.of(name, difficulty, locations, geodes, monsters, content_pack)
