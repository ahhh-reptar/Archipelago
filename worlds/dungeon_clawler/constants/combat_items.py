...
class CombatItem:
    ...
    gauntlet = CombatItemData("Gauntlet", number_buff_items, [ItemFlags.block, ItemFlags.buff, ItemFlags.metal])
    helmet = CombatItemData("Helmet", number_buff_items, [ItemFlags.block, ItemFlags.metal])
    holy_shield = CombatItemData("Holy Shield", number_buff_items, [ItemFlags.avoidance, ItemFlags.buff, ItemFlags.metal], False)
    ...
    wood_oil = CombatItemData("Wood Oil", number_buff_items, [ItemFlags.block, ItemFlags.wood])
    ...
    hand_of_midas = CombatItemData("Hand of Midas", number_buff_items, [ItemFlags.coins, ItemFlags.metal])
    ...
    whetstone = CombatItemData("Whetstone", number_buff_items, [ItemFlags.damage, ItemFlags.metal])
