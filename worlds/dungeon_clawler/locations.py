...
from .options import DungeonClawlerOptions, Goal
...
def create_money_locations(multiworld: MultiWorld, player: int, world_options: DungeonClawlerOptions) -> None:
...
def create_monstermon_locations(multiworld: MultiWorld, player: int, world_options: DungeonClawlerOptions) -> None:
    for location_data in monstermon_locations:
        ...
        if world_options.shuffle_monstermon:
            ...
            location = DungeonClawlerLocation(player, name, None, region)
            location.place_locked_item(create_event_item(player, name))
        region.locations.append(location)


def create_outfit_locations(multiworld: MultiWorld, player: int, world_options: DungeonClawlerOptions) -> None:
