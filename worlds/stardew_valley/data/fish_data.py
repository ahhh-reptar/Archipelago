...
highlands_outside = (SVERegion.highlands_outside,)
...
arrowhead_shark = create_fish(SVEFish.arrowhead_shark, fable_reef, season.all_seasons, 95)
baby_lunaloo = create_fish(SVEFish.baby_lunaloo, ginger_island_ocean + fable_reef, season.all_seasons, 15, mod_name=ModNames.sve)
barred_knifejaw = create_fish(SVEFish.barred_knifejaw,ginger_island_ocean + fable_reef, season.all_seasons, 65, mod_name=ModNames.sve)
blue_tang = create_fish(SVEFish.blue_tang, ginger_island_ocean + fable_reef, season.all_seasons, 30, mod_name=ModNames.sve)
...
butterfish = create_fish(SVEFish.butterfish, shearwater, season.not_winter, 80, mod_name=ModNames.sve)
...
highlands_bass = create_fish(SVEFish.highlands_bass, highlands_outside, season.all_seasons, 45, mod_name=ModNames.sve)
...
lunaloo = create_fish(SVEFish.lunaloo, ginger_island_ocean + fable_reef, season.all_seasons, 70, mod_name=ModNames.sve)
...
ocean_sunfish = create_fish(SVEFish.ocean_sunfish, ginger_island_ocean + fable_reef, season.all_seasons, 90, mod_name=ModNames.sve)
puppyfish = create_fish(SVEFish.puppyfish, shearwater, season.not_winter, 90, mod_name=ModNames.sve)
...
seahorse = create_fish(SVEFish.seahorse, ginger_island_ocean + fable_reef, season.all_seasons, 25, mod_name=ModNames.sve)
shark = create_fish(SVEFish.shark, ginger_island_ocean + fable_reef, season.all_seasons, 110, mod_name=ModNames.sve)
shiny_lunaloo = create_fish(SVEFish.shiny_lunaloo, ginger_island_ocean + fable_reef, season.all_seasons, 110, mod_name=ModNames.sve)
snatcher_worm = create_fish(SVEFish.snatcher_worm, mutant_bug_lair, season.all_seasons, 75, mod_name=ModNames.sve)
starfish = create_fish(SVEFish.starfish, ginger_island_ocean + ocean, season.all_seasons, 75, mod_name=ModNames.sve)
...
wolf_snapper = create_fish(SVEFish.wolf_snapper, shearwater, season.all_seasons, 110, mod_name=ModNames.sve)
