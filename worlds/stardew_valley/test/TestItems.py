...
from ..items import ResourcePackData, ItemData, item_table, Group


def test_can_transform_resource_pack_data_into_idem_data():
    resource_pack = ResourcePackData("item name")

    items = resource_pack.as_item_data(0)
...
def test_items_table_footprint_is_between_717000_and_720000():
    ...
    assert item_with_highest_id.code < 720000
