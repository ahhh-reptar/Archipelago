...
clam = BundleItem.item_bundle("Clam", 372, 1, 0)
cockle = BundleItem.item_bundle("Cockle", 718, 1, 0)
mussel = BundleItem.item_bundle("Mussel", 719, 1, 0)
oyster = BundleItem.item_bundle("Oyster", 723, 1, 0)
...
lobster = BundleItem.item_bundle("Lobster", 715, 1, 0)
crab = BundleItem.item_bundle("Crab", 717, 1, 0)
shrimp = BundleItem.item_bundle("Shrimp", 720, 1, 0)
crayfish = BundleItem.item_bundle("Crayfish", 716, 1, 0)
snail = BundleItem.item_bundle("Snail", 721, 1, 0)
periwinkle = BundleItem.item_bundle("Periwinkle", 722, 1, 0)
