...
from ...data.requirement import ToolRequirement, BookRequirement, SkillRequirement, TotalEarningsRequirement, \
    GrangeDisplayRequirement, \
    EggHuntRequirement, CaughtFishRequirement, MuseumCompletionRequirement, BuildingRequirement, NumberOfFriendsRequirement, \
    CookedRecipesRequirement, CraftedItemsRequirement, HelpWantedRequirement, ShipOneCropRequirement, \
...
pelican_town = ContentPack(
    ...
    shop_sources={
        ...
        Book.animal_catalogue: (
            Tag(ItemTag.BOOK, ItemTag.BOOK_POWER),
            ShopSource(price=5000, shop_region=Region.ranch),),
