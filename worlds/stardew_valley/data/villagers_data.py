...
universal_loves = {*golden_pumpkin, *magic_rock_candy, *pearl, *prismatic_shard, *rabbit_foot}
...
elliott_loves = crab_cakes | duck_feather | lobster | pomegranate | squid_ink | tom_kha_soup
coffee = {"Coffee"}
pickles = {"Pickles"}
super_meal = {"Super Meal"}
truffle_oil = {"Truffle Oil"}
wine = {"Wine"}
harvey_loves = coffee | pickles | super_meal | truffle_oil | wine
...
sashimi = {"Sashimi"}
void_egg = {"Void Egg"}
sebastian_loves = frozen_tear | obsidian | pumpkin_soup | sashimi | void_egg
beer = {"Beer"}
hot_pepper = {"Hot Pepper"}
pepper_poppers = {"Pepper Poppers"}
shane_loves = beer | hot_pepper | pepper_poppers | pizza
amethyst = {"Amethyst"}
...
pumpkin = {"Pumpkin"}
spicy_eel = {"Spicy Eel"}
abigail_loves = amethyst | banana_pudding | blackberry_cobbler | chocolate_cake | pufferfish | pumpkin | spicy_eel
...
leah_loves = goat_cheese | poppyseed_muffin | salad | stir_fry | truffle | vegetable_medley | wine
...
maru_loves = battery_pack | cauliflower | cheese_cauliflower | diamond | gold_bar | iridium_bar | miners_treat |\
             pepper_poppers | radioactive_bar | rhubarb_pie | strawberry
melon = {"Melon"}
poppy = {"Poppy"}
red_plate = {"Red Plate"}
roots_platter = {"Roots Platter"}
sandfish = {"Sandfish"}
penny_loves = diamond | emerald | melon | poppy | poppyseed_muffin | red_plate | roots_platter | sandfish | tom_kha_soup
fish_taco = {"Fish Taco"}
green_tea = {"Green Tea"}
summer_spangle = {"Summer Spangle"}
tropical_curry = {"Tropical Curry"}
caroline_loves = fish_taco | green_tea | summer_spangle | tropical_curry
...
demetrius_loves = bean_hotpot | ice_cream | rice_pudding | strawberry
...
stuffing = {"Stuffing"}
tulip = {"Tulip"}
evelyn_loves = beet | chocolate_cake | diamond | fairy_rose | stuffing | tulip
fried_mushroom = {"Fried Mushroom"}
leek = {"Leek"}
george_loves = fried_mushroom | leek
escargot = {"Escargot"}
orange = {"Orange"}
gus_loves = diamond | escargot | fish_taco | orange | tropical_curry
...
fried_eel = {"Fried Eel"}
pancakes = {"Pancakes"}
jodi_loves = chocolate_cake | crispy_bass | diamond | eggplant_parmesan | fried_eel | pancakes | rhubarb_pie |\
             vegetable_medley
...
lewis_loves = autumns_bounty | glazed_yams | green_tea | hot_pepper | vegetable_medley
blueberry_tart = {"Blueberry Tart"}
dish_o_the_sea = {"Dish O' The Sea"}
yam = {"Yam"}
linus_loves = blueberry_tart | cactus_fruit | coconut | dish_o_the_sea | yam
...
pam_loves = beer | cactus_fruit | glazed_yams | mead | pale_ale | parsnip | parsnip_soup | pina_colada
...
sweet_pea = {"Sweet Pea"}
sandy_loves = crocus | daffodil | mango_stocky_rice | sweet_pea
...
sandy = villager("Sandy", False, desert, "Fall", universal_loves | sandy_loves, False)
