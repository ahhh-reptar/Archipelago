...
vanilla_regions = [
    ...
    RegionData(Region.island_south, [Entrance.island_south_to_west, Entrance.island_south_to_north,
                                     ...
                                     Entrance.parrot_express_docks_to_jungle], is_ginger_island=True),
    ...
    RegionData(Region.island_west,
               [Entrance.island_west_to_islandfarmhouse, Entrance.island_west_to_gourmand_cave,
                ...
                Entrance.parrot_express_jungle_to_volcano], is_ginger_island=True),
    ...
    RegionData(Region.island_north, [Entrance.talk_to_island_trader, Entrance.island_north_to_field_office,
                                     ...
                                     Entrance.parrot_express_volcano_to_docks], is_ginger_island=True),
    ...
    RegionData(Region.island_farmhouse, is_ginger_island=True),
    ...
    RegionData(Region.dig_site,
               [Entrance.dig_site_to_professor_snail_cave, Entrance.parrot_express_dig_site_to_volcano,
                Entrance.parrot_express_dig_site_to_docks, Entrance.parrot_express_dig_site_to_jungle], is_ginger_island=True),
...
vanilla_connections = [
    ConnectionData(Entrance.to_stardew_valley, Region.stardew_valley, Region.menu),
    ConnectionData(Entrance.to_farmhouse, Region.farm_house, Region.stardew_valley),
    ConnectionData(Entrance.farmhouse_to_farm, Region.farm, Region.farm_house),
    ConnectionData(Entrance.downstairs_to_cellar, Region.cellar, Region.farm),
    ConnectionData(Entrance.farm_to_backwoods, Region.backwoods, Region.farm),
    ConnectionData(Entrance.farm_to_bus_stop, Region.bus_stop, Region.farm),
    ConnectionData(Entrance.farm_to_forest, Region.forest, Region.farm),
    ConnectionData(Entrance.farm_to_farmcave, Region.farm_cave, Region.farm, flag=RandomizationFlag.NON_PROGRESSION),
    ConnectionData(Entrance.enter_greenhouse, Region.greenhouse, Region.farm),
    ConnectionData(Entrance.use_desert_obelisk, Region.desert, Region.farm),
    ConnectionData(Entrance.use_island_obelisk, Region.island_south, Region.farm, flag=RandomizationFlag.GINGER_ISLAND),
    ConnectionData(Entrance.use_farm_obelisk, Region.farm, Region.island_south),
    ConnectionData(Entrance.backwoods_to_mountain, Region.mountain, Region.backwoods),
    ConnectionData(Entrance.bus_stop_to_town, Region.town, Region.bus_stop),
    ConnectionData(Entrance.bus_stop_to_tunnel_entrance, Region.tunnel_entrance, Region.bus_stop),
    ConnectionData(Entrance.tunnel_entrance_to_bus_tunnel, Region.bus_tunnel, Region.tunnel_entrance, flag=RandomizationFlag.NON_PROGRESSION),
    ConnectionData(Entrance.take_bus_to_desert, Region.desert, Region.bus_stop),
    ConnectionData(Entrance.forest_to_town, Region.town, Region.forest),
    ConnectionData(Entrance.forest_to_wizard_tower, Region.wizard_tower, Region.forest,
                   flag=RandomizationFlag.NON_PROGRESSION | RandomizationFlag.LEAD_TO_OPEN_AREA),
    ConnectionData(Entrance.enter_wizard_basement, Region.wizard_basement, Region.wizard_tower, flag=RandomizationFlag.BUILDINGS),
    ConnectionData(Entrance.forest_to_marnie_ranch, Region.ranch, Region.forest,
                   flag=RandomizationFlag.NON_PROGRESSION | RandomizationFlag.LEAD_TO_OPEN_AREA),
    ConnectionData(Entrance.forest_to_leah_cottage, Region.leah_house, Region.forest,
                   flag=RandomizationFlag.BUILDINGS | RandomizationFlag.LEAD_TO_OPEN_AREA),
    ConnectionData(Entrance.enter_secret_woods, Region.secret_woods, Region.forest),
    ConnectionData(Entrance.forest_to_sewer, Region.sewer, Region.forest, flag=RandomizationFlag.BUILDINGS),
    ConnectionData(Entrance.buy_from_traveling_merchant, Region.traveling_cart, Region.forest),
    ConnectionData(Entrance.town_to_sewer, Region.sewer, Region.town, flag=RandomizationFlag.BUILDINGS),
    ConnectionData(Entrance.enter_mutant_bug_lair, Region.mutant_bug_lair, Region.sewer, flag=RandomizationFlag.BUILDINGS),
    ConnectionData(Entrance.mountain_to_railroad, Region.railroad, Region.mountain),
    ConnectionData(Entrance.mountain_to_tent, Region.tent, Region.mountain,
                   flag=RandomizationFlag.NON_PROGRESSION | RandomizationFlag.LEAD_TO_OPEN_AREA),
    ConnectionData(Entrance.mountain_to_leo_treehouse, Region.leo_treehouse, Region.mountain,
                   flag=RandomizationFlag.BUILDINGS | RandomizationFlag.LEAD_TO_OPEN_AREA | RandomizationFlag.GINGER_ISLAND),
    ConnectionData(Entrance.mountain_to_carpenter_shop, Region.carpenter, Region.mountain,
                   flag=RandomizationFlag.NON_PROGRESSION | RandomizationFlag.LEAD_TO_OPEN_AREA),
    ConnectionData(Entrance.mountain_to_maru_room, Region.maru_room, Region.mountain,
                   flag=RandomizationFlag.BUILDINGS | RandomizationFlag.LEAD_TO_OPEN_AREA),
    ConnectionData(Entrance.enter_sebastian_room, Region.sebastian_room, Region.carpenter, flag=RandomizationFlag.BUILDINGS),
    ConnectionData(Entrance.mountain_to_adventurer_guild, Region.adventurer_guild, Region.mountain,
                   flag=RandomizationFlag.BUILDINGS | RandomizationFlag.LEAD_TO_OPEN_AREA),
    ConnectionData(Entrance.enter_quarry, Region.quarry, Region.mountain),
    ConnectionData(Entrance.enter_quarry_mine_entrance, Region.quarry_mine_entrance, Region.quarry,
                   flag=RandomizationFlag.BUILDINGS),
    ConnectionData(Entrance.enter_quarry_mine, Region.quarry_mine, Region.quarry_mine_entrance),
    ConnectionData(Entrance.mountain_to_town, Region.town, Region.mountain),
    ConnectionData(Entrance.town_to_community_center, Region.community_center, Region.town,
                   flag=RandomizationFlag.PELICAN_TOWN | RandomizationFlag.LEAD_TO_OPEN_AREA),
    ConnectionData(Entrance.access_crafts_room, Region.crafts_room, Region.community_center),
    ConnectionData(Entrance.access_pantry, Region.pantry, Region.community_center),
    ConnectionData(Entrance.access_fish_tank, Region.fish_tank, Region.community_center),
    ConnectionData(Entrance.access_boiler_room, Region.boiler_room, Region.community_center),
    ConnectionData(Entrance.access_bulletin_board, Region.bulletin_board, Region.community_center),
    ConnectionData(Entrance.access_vault, Region.vault, Region.community_center),
    ConnectionData(Entrance.town_to_hospital, Region.hospital, Region.town,
                   flag=RandomizationFlag.PELICAN_TOWN | RandomizationFlag.LEAD_TO_OPEN_AREA),
    ConnectionData(Entrance.enter_harvey_room, Region.harvey_room, Region.hospital, flag=RandomizationFlag.BUILDINGS),
    ConnectionData(Entrance.town_to_pierre_general_store, Region.pierre_store, Region.town,
                   flag=RandomizationFlag.PELICAN_TOWN | RandomizationFlag.LEAD_TO_OPEN_AREA),
    ConnectionData(Entrance.enter_sunroom, Region.sunroom, Region.pierre_store, flag=RandomizationFlag.BUILDINGS),
    ConnectionData(Entrance.town_to_clint_blacksmith, Region.blacksmith, Region.town,
                   flag=RandomizationFlag.PELICAN_TOWN | RandomizationFlag.LEAD_TO_OPEN_AREA),
    ConnectionData(Entrance.town_to_saloon, Region.saloon, Region.town,
                   flag=RandomizationFlag.PELICAN_TOWN | RandomizationFlag.LEAD_TO_OPEN_AREA),
    ...
    ConnectionData(Entrance.town_to_sam_house, Region.sam_house, Region.town,
                   flag=RandomizationFlag.PELICAN_TOWN | RandomizationFlag.LEAD_TO_OPEN_AREA),
    ConnectionData(Entrance.town_to_haley_house, Region.haley_house, Region.town,
                   flag=RandomizationFlag.PELICAN_TOWN | RandomizationFlag.LEAD_TO_OPEN_AREA),
    ConnectionData(Entrance.town_to_mayor_manor, Region.mayor_house, Region.town,
                   flag=RandomizationFlag.PELICAN_TOWN | RandomizationFlag.LEAD_TO_OPEN_AREA),
    ConnectionData(Entrance.town_to_alex_house, Region.alex_house, Region.town,
                   flag=RandomizationFlag.PELICAN_TOWN | RandomizationFlag.LEAD_TO_OPEN_AREA),
    ConnectionData(Entrance.town_to_trailer, Region.trailer, Region.town,
                   flag=RandomizationFlag.PELICAN_TOWN | RandomizationFlag.LEAD_TO_OPEN_AREA),
    ConnectionData(Entrance.town_to_museum, Region.museum, Region.town,
                   flag=RandomizationFlag.PELICAN_TOWN | RandomizationFlag.LEAD_TO_OPEN_AREA),
    ConnectionData(Entrance.town_to_jojamart, Region.jojamart, Region.town,
                   flag=RandomizationFlag.PELICAN_TOWN | RandomizationFlag.LEAD_TO_OPEN_AREA),
    ConnectionData(Entrance.town_to_beach, Region.beach, Region.town),
    ConnectionData(Entrance.enter_elliott_house, Region.elliott_house, Region.beach,
                   flag=RandomizationFlag.BUILDINGS | RandomizationFlag.LEAD_TO_OPEN_AREA),
    ConnectionData(Entrance.beach_to_willy_fish_shop, Region.fish_shop, Region.beach,
                   flag=RandomizationFlag.NON_PROGRESSION | RandomizationFlag.LEAD_TO_OPEN_AREA),
    ConnectionData(Entrance.fish_shop_to_boat_tunnel, Region.boat_tunnel, Region.fish_shop,
                   flag=RandomizationFlag.BUILDINGS | RandomizationFlag.GINGER_ISLAND),
    ConnectionData(Entrance.boat_to_ginger_island, Region.island_south, Region.boat_tunnel, flag=RandomizationFlag.GINGER_ISLAND),
    ConnectionData(Entrance.enter_tide_pools, Region.tide_pools, Region.beach),
    ConnectionData(Entrance.mountain_to_the_mines, Region.mines, Region.mountain,
                   flag=RandomizationFlag.NON_PROGRESSION | RandomizationFlag.LEAD_TO_OPEN_AREA),
    ConnectionData(Entrance.talk_to_mines_dwarf, Region.mines_dwarf_shop, Region.mines),
    ConnectionData(Entrance.dig_to_mines_floor_5, Region.mines_floor_5, Region.mines),
    ConnectionData(Entrance.dig_to_mines_floor_10, Region.mines_floor_10, Region.mines),
    ConnectionData(Entrance.dig_to_mines_floor_15, Region.mines_floor_15, Region.mines),
    ConnectionData(Entrance.dig_to_mines_floor_20, Region.mines_floor_20, Region.mines),
    ConnectionData(Entrance.dig_to_mines_floor_25, Region.mines_floor_25, Region.mines),
    ConnectionData(Entrance.dig_to_mines_floor_30, Region.mines_floor_30, Region.mines),
    ConnectionData(Entrance.dig_to_mines_floor_35, Region.mines_floor_35, Region.mines),
    ConnectionData(Entrance.dig_to_mines_floor_40, Region.mines_floor_40, Region.mines),
    ConnectionData(Entrance.dig_to_mines_floor_45, Region.mines_floor_45, Region.mines),
    ConnectionData(Entrance.dig_to_mines_floor_50, Region.mines_floor_50, Region.mines),
    ConnectionData(Entrance.dig_to_mines_floor_55, Region.mines_floor_55, Region.mines),
    ConnectionData(Entrance.dig_to_mines_floor_60, Region.mines_floor_60, Region.mines),
    ConnectionData(Entrance.dig_to_mines_floor_65, Region.mines_floor_65, Region.mines),
    ConnectionData(Entrance.dig_to_mines_floor_70, Region.mines_floor_70, Region.mines),
    ConnectionData(Entrance.dig_to_mines_floor_75, Region.mines_floor_75, Region.mines),
    ConnectionData(Entrance.dig_to_mines_floor_80, Region.mines_floor_80, Region.mines),
    ConnectionData(Entrance.dig_to_mines_floor_85, Region.mines_floor_85, Region.mines),
    ConnectionData(Entrance.dig_to_mines_floor_90, Region.mines_floor_90, Region.mines),
    ConnectionData(Entrance.dig_to_mines_floor_95, Region.mines_floor_95, Region.mines),
    ConnectionData(Entrance.dig_to_mines_floor_100, Region.mines_floor_100, Region.mines),
    ConnectionData(Entrance.dig_to_mines_floor_105, Region.mines_floor_105, Region.mines),
    ConnectionData(Entrance.dig_to_mines_floor_110, Region.mines_floor_110, Region.mines),
    ConnectionData(Entrance.dig_to_mines_floor_115, Region.mines_floor_115, Region.mines),
    ConnectionData(Entrance.dig_to_mines_floor_120, Region.mines_floor_120, Region.mines),
    ...
    ConnectionData(Entrance.mine_to_skull_cavern_floor_25, Region.skull_cavern_25, Region.skull_cavern),
    ConnectionData(Entrance.mine_to_skull_cavern_floor_50, Region.skull_cavern_50, Region.skull_cavern),
    ConnectionData(Entrance.mine_to_skull_cavern_floor_75, Region.skull_cavern_75, Region.skull_cavern),
    ConnectionData(Entrance.mine_to_skull_cavern_floor_100, Region.skull_cavern_100, Region.skull_cavern),
    ConnectionData(Entrance.mine_to_skull_cavern_floor_125, Region.skull_cavern_125, Region.skull_cavern),
    ConnectionData(Entrance.mine_to_skull_cavern_floor_150, Region.skull_cavern_150, Region.skull_cavern),
    ConnectionData(Entrance.mine_to_skull_cavern_floor_175, Region.skull_cavern_175, Region.skull_cavern),
    ConnectionData(Entrance.mine_to_skull_cavern_floor_200, Region.skull_cavern_200, Region.skull_cavern),
    ...
    ConnectionData(Entrance.island_south_to_west, Region.island_west, Region.island_south, flag=RandomizationFlag.GINGER_ISLAND),
    ConnectionData(Entrance.island_south_to_north, Region.island_north, Region.island_south, flag=RandomizationFlag.GINGER_ISLAND),
    ConnectionData(Entrance.island_south_to_east, Region.island_east, Region.island_south, flag=RandomizationFlag.GINGER_ISLAND),
    ConnectionData(Entrance.island_south_to_southeast, Region.island_south_east, Region.island_south,
                   flag=RandomizationFlag.GINGER_ISLAND),
    ConnectionData(Entrance.use_island_resort, Region.island_resort, Region.island_south, flag=RandomizationFlag.GINGER_ISLAND),
    ConnectionData(Entrance.island_west_to_islandfarmhouse, Region.island_farmhouse, Region.island_west,
                   flag=RandomizationFlag.BUILDINGS | RandomizationFlag.GINGER_ISLAND),
    ConnectionData(Entrance.island_west_to_gourmand_cave, Region.gourmand_frog_cave, Region.island_west,
                   flag=RandomizationFlag.BUILDINGS | RandomizationFlag.GINGER_ISLAND),
    ConnectionData(Entrance.island_west_to_crystals_cave, Region.colored_crystals_cave, Region.island_west,
                   flag=RandomizationFlag.BUILDINGS | RandomizationFlag.GINGER_ISLAND),
    ConnectionData(Entrance.island_west_to_shipwreck, Region.shipwreck, Region.island_west,
                   flag=RandomizationFlag.BUILDINGS | RandomizationFlag.GINGER_ISLAND),
    ConnectionData(Entrance.island_west_to_qi_walnut_room, Region.qi_walnut_room, Region.island_west,
                   flag=RandomizationFlag.BUILDINGS | RandomizationFlag.GINGER_ISLAND),
    ConnectionData(Entrance.island_east_to_leo_hut, Region.leo_hut, Region.island_east,
                   flag=RandomizationFlag.BUILDINGS | RandomizationFlag.GINGER_ISLAND),
    ConnectionData(Entrance.island_east_to_island_shrine, Region.island_shrine, Region.island_east,
                   flag=RandomizationFlag.BUILDINGS | RandomizationFlag.GINGER_ISLAND),
    ConnectionData(Entrance.island_southeast_to_pirate_cove, Region.pirate_cove, Region.island_south_east,
                   flag=RandomizationFlag.BUILDINGS | RandomizationFlag.GINGER_ISLAND),
    ConnectionData(Entrance.island_north_to_field_office, Region.field_office, Region.island_north,
                   flag=RandomizationFlag.BUILDINGS | RandomizationFlag.GINGER_ISLAND),
    ConnectionData(Entrance.island_north_to_dig_site, Region.dig_site, Region.island_north, flag=RandomizationFlag.GINGER_ISLAND),
    ConnectionData(Entrance.dig_site_to_professor_snail_cave, Region.professor_snail_cave, Region.dig_site, flag=RandomizationFlag.BUILDINGS | RandomizationFlag.GINGER_ISLAND),
    ConnectionData(Entrance.island_north_to_volcano, Region.volcano, Region.island_north,
                   flag=RandomizationFlag.BUILDINGS | RandomizationFlag.GINGER_ISLAND),
    ConnectionData(Entrance.volcano_to_secret_beach, Region.volcano_secret_beach, Region.volcano,
                   flag=RandomizationFlag.BUILDINGS | RandomizationFlag.GINGER_ISLAND),
    ConnectionData(Entrance.talk_to_island_trader, Region.island_trader, Region.island_north, flag=RandomizationFlag.GINGER_ISLAND),
    ConnectionData(Entrance.climb_to_volcano_5, Region.volcano_floor_5, Region.volcano, flag=RandomizationFlag.GINGER_ISLAND),
    ConnectionData(Entrance.talk_to_volcano_dwarf, Region.volcano_dwarf_shop, Region.volcano_floor_5, flag=RandomizationFlag.GINGER_ISLAND),
    ConnectionData(Entrance.climb_to_volcano_10, Region.volcano_floor_10, Region.volcano_floor_5, flag=RandomizationFlag.GINGER_ISLAND),
    ConnectionData(Entrance.parrot_express_jungle_to_docks, Region.island_south, Region.island_east, flag=RandomizationFlag.GINGER_ISLAND),
    ConnectionData(Entrance.parrot_express_dig_site_to_docks, Region.island_south, Region.dig_site, flag=RandomizationFlag.GINGER_ISLAND),
    ConnectionData(Entrance.parrot_express_volcano_to_docks, Region.island_south, Region.island_north, flag=RandomizationFlag.GINGER_ISLAND),
    ConnectionData(Entrance.parrot_express_volcano_to_jungle, Region.island_west, Region.island_north, flag=RandomizationFlag.GINGER_ISLAND),
    ConnectionData(Entrance.parrot_express_docks_to_jungle, Region.island_west, Region.island_south, flag=RandomizationFlag.GINGER_ISLAND),
    ConnectionData(Entrance.parrot_express_dig_site_to_jungle, Region.island_west, Region.dig_site, flag=RandomizationFlag.GINGER_ISLAND),
    ConnectionData(Entrance.parrot_express_docks_to_dig_site, Region.dig_site, Region.island_south, flag=RandomizationFlag.GINGER_ISLAND),
    ConnectionData(Entrance.parrot_express_volcano_to_dig_site, Region.dig_site, Region.island_north, flag=RandomizationFlag.GINGER_ISLAND),
    ConnectionData(Entrance.parrot_express_jungle_to_dig_site, Region.dig_site, Region.island_east, flag=RandomizationFlag.GINGER_ISLAND),
    ConnectionData(Entrance.parrot_express_dig_site_to_volcano, Region.island_north, Region.dig_site, flag=RandomizationFlag.GINGER_ISLAND),
    ConnectionData(Entrance.parrot_express_docks_to_volcano, Region.island_north, Region.island_south, flag=RandomizationFlag.GINGER_ISLAND),
    ConnectionData(Entrance.parrot_express_jungle_to_volcano, Region.island_north, Region.island_east, flag=RandomizationFlag.GINGER_ISLAND),
]
...
def create_regions(region_factory: RegionFactory, random: Random, world_options) -> Tuple[
    Dict[str, Region], Dict[str, str], List[RegionData]]:
    ...
    regions = connect_regions(connections, entrances, regions, world_options)

    return regions, randomized_data, final_regions


def connect_regions(connections, entrances, regions, world_options):
    # exclude_island = world_options.exclude_ginger_island == ExcludeGingerIsland.option_true
    for connection in connections:
        if connection.destination not in regions: # or connection.origin not in regions:
            continue
        if connection.name in entrances:
            entrances[connection.name].connect(regions[connection.destination])
        # if exclude_island and RandomizationFlag.GINGER_ISLAND in connection.flag:
        #     regions[connection.origin].exits = \
        #         [entrance for entrance in regions[connection.origin].exits if entrance.name != connection.name]
        #     regions.pop(connection.destination)
    return regions
...
def create_connections_for_generation(randomized_connections: Dict[ConnectionData, ConnectionData]) -> List[
    ...
    for connection in randomized_connections:
        ...
        connections.append(ConnectionData(connection.name, destination.destination, connection.origin, destination.reverse, flag=connection.flag))
    return connections
