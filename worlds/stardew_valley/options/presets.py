...
all_random_settings = {
    ...
    options.Secretsanity.internal_name:             "random",
...
medium_settings = {
    ...
    options.Walnutsanity.internal_name:             options.Walnutsanity.preset_none,
    options.Secretsanity.internal_name:             options.Secretsanity.option_reasonable,
...
hard_settings = {
    ...
    options.Secretsanity.internal_name:             options.Secretsanity.option_reasonable_fish,
