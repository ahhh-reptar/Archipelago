...
stardew_valley_regions = [
    ...
    RegionData("Trailer", [], RandomizationFlag.PELICAN_TOWN),
...
mandatory_connections = [
    ...
    ConnectionData("Town to Hospital", "Hospital", "Hospital to Town", RandomizationFlag.PELICAN_TOWN),
    ...
    ConnectionData("Town to Saloon", "Saloon", "Saloon to Town", RandomizationFlag.PELICAN_TOWN),
    ...
    ConnectionData("Town to Trailer", "Trailer", "Trailer to Town", RandomizationFlag.PELICAN_TOWN),
