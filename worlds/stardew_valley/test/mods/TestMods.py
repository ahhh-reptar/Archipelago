...
@classvar_matrix(mod=sorted(all_mods))
class TestModsCanGenerate(WorldAssertMixin, ModAssertMixin, SVTestCase):
    mod = ClassVar[str]
...
class TestAllsanityWithModsCanGenerate(WorldAssertMixin, ModAssertMixin, SVTestCase):
...
@classvar_matrix(mod=sorted(all_mods.difference([
...
class TestModEntranceRandomizationBuildingsCanGenerate(WorldAssertMixin, SVTestCase):
