...
class StardewLogic:
    ...
    def __post_init__(self):
        ...
        self.quest_rules.update({
            ...
            Quest.the_mysterious_qi: self.can_reach_region(Region.bus_tunnel) & self.has(ArtisanGood.battery_pack) & self.can_reach_region(Region.railroad) & self.has(Forageable.rainbow_shell) & self.can_reach_region(Region.mayor_house) & self.has(Vegetable.beet) & self.can_reach_region(Region.desert) & self.has(Loot.solar_essence),
