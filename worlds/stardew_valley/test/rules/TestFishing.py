...
class TestNeedRegionToCatchFish(SVTestBase):
    ...
    def test_catch_fish_requires_region_unlock(self):
        fish_and_items = {
            ...
            Fish.woodskip: ["Landslide Removed", "Glittering Boulder Removed", "Progressive Weapon"],  # For the ores to get the axe upgrades
            ...
            Fish.ice_pip: ["Landslide Removed", "Progressive Weapon", "Progressive Weapon"],
            Fish.lava_eel: ["Landslide Removed", "Progressive Weapon", "Progressive Weapon", "Progressive Weapon"],
